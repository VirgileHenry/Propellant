...
def write_mesh_to_file(context, filepath):
    ...
    for ob in obs:
        ...
        if smooth_shading:
            ...
            # compute triangles
            # loop over faces, and write all vertex index of triangles of length 3
...
class ExportSomeData(Operator, ExportHelper):
    ...
    def execute(self, context):
        return write_mesh_to_file(context, self.filepath)
